...
painting1 = D.Painting 0 "Picasso"
   "Guernica" "1930s" ""
   D.Historical D.Spanish ""
   [D.Concept "war" 0.82,
    D.Concept "art" 0.95,
    D.Concept "abstract" 0.90,
    D.Concept "cubism" 0.62
   ]

painting2 :: D.Painting
painting2 = D.Painting 1 "Picasso"
   "Demoiselles D'Avignon" "1920s" ""
   D.Interior D.Spanish ""
   [D.Concept "female" 0.96,
    D.Concept "art" 0.97,
    D.Concept "abstract" 0.93,
    D.Concept "cubism" 0.79
   ]

painting3 :: D.Painting
painting3 = D.Painting 2 "Pollock"
   "Autumn Rhythm (Number 30)" "1950s" ""
   D.OtherGenre D.American ""
   [D.Concept "expressionism" 0.96,
    D.Concept "art" 0.94,
    D.Concept "abstract" 0.98,
    D.Concept "cubism" 0.67
   ]

painting4 :: D.Painting
painting4 = D.Painting 3 "Pollock"
   "Number 1 (Lavender Mist)" "1950s" ""
   D.OtherGenre D.American ""
   [D.Concept "expressionism" 0.98,
    D.Concept "art" 0.98,
    D.Concept "abstract" 0.97,
    D.Concept "cubism" 0.54
   ]

paintings :: [D.Painting]
paintings = [painting1, painting2, painting3, painting4]

-- to test another fn, do i need another spec?

spec :: Spec
spec =
  describe "my cool tests" $ do
